...
extension ViewController {
    ...
    var state: State {
        ...
        set {
            print(">>> set state \(state) : \(newValue)")
            ...
            case .notReady:
                ...
                if let camera = self.sceneView.session.currentFrame?.camera {
                    ...
                    case .normal:
                        print(">>> commented out .scanning state, here")
//                        newState = .scanning
                    default:
                        break
                    }
            ...
            case .testing:
                print(">>> In Testing!!!, scan?.boundingBoxExists \(scan?.boundingBoxExists), referenceObjectToTest \(referenceObjectToTest)")
