...
class TestRun {
    ...
    // The ARReferenceObject(s) to be tested in this run.
    ...
    func setReferenceObjects(_ objects: Set<ARReferenceObject>, screenshot: UIImage?) {
        self.referenceObjects = objects
        guard let referenceObject = objects.first else { return }
        ...
        self.detectedObject = DetectedObject(referenceObject: referenceObject)
